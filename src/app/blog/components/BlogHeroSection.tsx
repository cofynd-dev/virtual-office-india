  ...
  return (
    <section className="relative overflow-hidden bg-[#F5F5F4] text-foreground">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-14 text-center">
        ...
        >
          Virtual Office <span className="text-[#7B765E]">Guides</span>
        </h1>

        <p className="hero-animate-3 mt-4 text-sm sm:text-base text-foreground-muted leading-relaxed max-w-xl mx-auto">
          Practical articles on virtual offices, GST addresses, company registration and choosing the right city
          for your business.
        </p>
      </div>
    </section>
