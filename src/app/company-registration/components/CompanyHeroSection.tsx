...
const trustItems = [
  ...
  { icon: "AdjustmentsHorizontalIcon" as const, label: "Flexible Plans" },
    ...
    <section className="relative overflow-hidden bg-[#F5F5F4] text-foreground">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 lg:pt-32 pb-14 sm:pb-18 lg:pb-20 text-center">
        <nav className="flex items-center justify-center gap-2 text-xs text-foreground-muted hero-animate-1">
          ...
          <span className="text-foreground font-medium">Company Registration</span>
        </nav>
        ...
        >
          Virtual Office for <span className="text-[#7B765E]">Company Registration</span> in India
        </h1>

        <p className="hero-animate-3 mt-5 text-base sm:text-lg text-foreground-muted leading-relaxed max-w-2xl mx-auto">
          Get a professional registered-office address for your business without renting a traditional
          office.
        </p>
      ...
      <ContactModal
        ...
        metadata={{ action: "company-hero-cta", page: "company-registration" }}
      />
    </section>
  );
}
