...
export default function CompanyCitiesSection() {
  return (
    <section id="company-cities" className="py-16 sm:py-20 bg-[#F9F8F6]">
          ...
          <div className="scroll-reveal flex flex-col items-center text-center">
            ...
            >
              ...
              <span className="leading-tight min-w-0 text-center">
                Company Registration Virtual Office in Your City
              </span>
            </h2>
            <p className="mt-3 text-center text-foreground-muted max-w-xl text-sm sm:text-base leading-relaxed mx-auto">
              Choose a city to see the available locations, plans, and documentation offered there.
            </p>
          </div>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-4">
                  <h3 className="font-display font-extrabold text-white text-base sm:text-lg leading-tight [text-shadow:0_1px_2px_rgba(0,0,0,0.45)]">
                    Company Registration in {city.name}
                  </h3>
              ...
              <div className="flex flex-1 flex-col p-4 sm:p-5">
                <ul className="space-y-2">
                  {["Professional address", "MCA/company registration support"].map((tag) => (
                    <li key={tag} className="flex items-start gap-2">
                      ...
                      <span className="text-[13px] sm:text-sm text-foreground-muted leading-snug">{tag}</span>
                    </li>
                  ))}
                </ul>
